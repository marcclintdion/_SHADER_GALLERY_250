...
"       color_A               =  mix(color, fresnelTexture, fresnel) * (1.0 - acos(NdotL1)/attenuation_02) * attenuation_01;                                  \n"
//"         color_A               =  mix(color, fresnelTexture, fresnel) *         ((NdotL1 * 0.5)+ 0.5)*((NdotL1 * 0.5)+ 0.5)         * attenuation_01;                                  \n"
