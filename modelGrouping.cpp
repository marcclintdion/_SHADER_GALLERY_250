        ...
        Rotate(modelView, 1.0, flowerShield_ROTATE[1], flowerShield_ROTATE[2], flowerShield_ROTATE[3]+spinModel);         
        ...
        Rotate(modelView, 0.0, 1.0, 0.0, rotateModel[0]); 
        Rotate(modelView, 1.0, 0.0, 0.0, rotateModel[1]);                  
